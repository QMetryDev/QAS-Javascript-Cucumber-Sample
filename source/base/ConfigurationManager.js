...
const fs = require("fs");
exports.IntegrationPremise = 'automation.qmetry.onpremise';
exports.IntegrationType = 'automation.qmetry.type';
class ConfigurationManager {
    constructor() {
        ...
        if (!ConfigurationManager.integrationPropertiesReader) {
            ConfigurationManager.integrationPropertiesReader = PropertiesReader('resources/qmetry.properties');
        }
    }
    static setup() {
...
let cfg = new ConfigurationManager();
